...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and conditioning in the school pool",
    ...
    "Music Ensemble": {
        "description": "Practice instruments and perform ensemble pieces",
    ...
    "Debate Society": {
        "description": "Develop public speaking and argument skills through debates",
